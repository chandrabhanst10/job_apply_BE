...
import { uploadResume, validateResumeFileHeader } from "../../middleware/upload.js";
...
resumeRouter.post("/", uploadResume.single("resume"), validateResumeFileHeader, controller.uploadResumeController);
